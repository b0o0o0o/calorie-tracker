...
export const AUTRES: FoodItem[] = [
    ...
    // Farines de base
    { foodId: 'AU029', label: 'Farine de blé T80', nutrients: { calories: 340, protein: 11, carbs: 70, fat: 1.5 }, unit: 'g', category: 'cereal' },
    { foodId: 'AU030', label: 'Farine de blé T110', nutrients: { calories: 335, protein: 12, carbs: 67, fat: 2.7 }, unit: 'g', category: 'cereal' },
    { foodId: 'AU031', label: 'Farine de seigle', nutrients: { calories: 335, protein: 8.5, carbs: 73, fat: 1.7 }, unit: 'g', category: 'cereal' },
    { foodId: 'AU032', label: 'Farine de sarrasin', nutrients: { calories: 335, protein: 12, carbs: 67, fat: 2.7 }, unit: 'g', category: 'cereal' },
    { foodId: 'AU033', label: 'Farine de pois chiche', nutrients: { calories: 387, protein: 22, carbs: 57, fat: 6.7 }, unit: 'g', category: 'cereal' },
    { foodId: 'AU034', label: 'Farine de riz', nutrients: { calories: 366, protein: 6, carbs: 80, fat: 1 }, unit: 'g', category: 'cereal' },
    { foodId: 'AU035', label: 'Farine de maïs', nutrients: { calories: 361, protein: 7, carbs: 76, fat: 3.9 }, unit: 'g', category: 'cereal' },
